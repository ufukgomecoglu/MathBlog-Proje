<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AnswerAdd.aspx.cs" Inherits="MathBlog.Admin.AnswerAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="formContainer">
        ...
        <div style="text-align: center">
            <asp:LinkButton ID="linkbutton_addanswer" CssClass="formButton" Text="Add Answer" runat="server" OnClick="linkbutton_addanswer_Click" />
        </div>
    </div>
     <script>
